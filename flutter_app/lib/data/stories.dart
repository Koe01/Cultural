...
const List<Story> stories = [
  Story(
    ...
    excerpt:
        'A story of patience, craft, and celestial longing passed down through generations of artisans.',
    quote:
        'The moon watched her weave for thirty nights, until the cloth itself began to glow.',
    content:
        'In a valley where the mountains meet the clouds, there lived a weaver named Xunxi who created textiles so intricate that travelers came from distant lands to witness her work.\n\n'
  ...
  Story(
    ...
    quote:
        'Three sighs for sorrow, three for hope, and three for the path between.',
    content:
        'In a time before written records, two villages stood on opposite banks of a river that could not be crossed during monsoon season. For six months of the year, families were separated, lovers kept apart, and news traveled only through the wind.\n\n'
  ...
  Story(
    ...
    excerpt:
        'Not all libraries are built of stone; some are kept in the hearts of those who refuse to forget.',
    content:
        'When invaders came to burn the great libraries of Timbuktu, the scholars made a pact. Each would memorize entire manuscripts—not just the words, but the spaces between them, the marginalia, even the stains left by previous readers\' fingers.\n\n'
  ...
  Story(
    ...
    excerpt:
        'In the far north, there are those who collect vanishing sounds before they disappear forever.',
    quote:
        'She kept the last echo of her grandmother\'s laughter in a small glass bottle by the window.',
    content:
        'In the coldest part of Iceland, where glaciers remember things that humans forget, there lived a woman who collected sounds. Not recordings—actual sounds, captured and preserved like rare butterflies.\n\n'
  ...
  Story(
    ...
    excerpt:
        'Sometimes, the greatest gift is not to remember, but to be released from memory.',
    content:
        'In a hidden tea house in Kyoto, there is a ceremony that only happens once in a person\'s lifetime. It is called the Tea of Forgetting, and it is offered to those who carry memories too heavy to bear.\n\n'
...
const List<Proverb> proverbs = [
  Proverb(
    id: 'p1',
    text: 'The mouth that eats salt should drink water',
    meaning:
        'One should take responsibility for the consequences of their actions',
    region: 'Igbo, Nigeria',
  ),
  Proverb(
    id: 'p2',
    ...
    meaning:
        'Sometimes you must solve problems while still experiencing them',
  ...
  Proverb(
    ...
    meaning:
        'Those who have been helped remember the helper, even if the helper forgets',
  ...
  Proverb(
    ...
    meaning:
        'Appearances can be deceiving; external judgments miss internal truth',
  ...
  Proverb(
    id: 'p7',
    text:
        'The stone in the water does not know how hot the one in the sun is',
  ...
  Proverb(
    ...
    meaning: 'Direct experience and mentorship surpass theoretical knowledge',
    region: 'China',
  ),
  Proverb(
    id: 'p10',
    text: 'The axe forgets; the tree remembers',
    meaning: 'Those who cause harm may forget, but those harmed carry the memory',
    region: 'Zimbabwe',
  ),
  Proverb(
    id: 'p11',
    text: 'A calm sea does not make a skilled sailor',
    meaning: 'Adversity builds strength and wisdom',
    region: 'East Africa',
  ),
  Proverb(
    id: 'p12',
    text: 'When the music changes, so does the dance',
    meaning: 'One must adapt when circumstances change',
    region: 'Hausa, Nigeria',
  ),
  Proverb(
    id: 'p13',
    text: 'The bamboo that bends is stronger than the oak that resists',
    meaning: 'Flexibility and humility are greater strengths than rigidity',
    region: 'Japan',
  ),
  Proverb(
    id: 'p14',
    text: 'However long the night, the dawn will break',
    meaning: 'Difficult times are temporary; hope persists',
    region: 'West Africa',
  ),
  Proverb(
    id: 'p15',
    text: 'A bird does not sing because it has an answer; it sings because it has a song',
    meaning: 'Expression is its own purpose and does not need justification',
    region: 'Maya, Guatemala',
  ),
  Proverb(
    id: 'p16',
    text: 'The earth is not thirsty for water, but for blood',
    meaning: 'Conflict drains more from a land than drought ever could',
    region: 'Kurdish tradition',
  ),
  Proverb(
    id: 'p17',
    text: 'If you want to go fast, go alone. If you want to go far, go together',
    meaning: 'Community and collaboration achieve lasting results',
    region: 'East Africa',
  ),
  Proverb(
    id: 'p18',
    text: 'The wound of words is worse than the wound of swords',
    meaning: 'Emotional harm can cut deeper than physical harm',
    region: 'Arabic tradition',
  ),
  Proverb(
    id: 'p19',
  ...
  Proverb(
    ...
    meaning: 'Exclusion breeds destruction; belonging is a fundamental need',
    region: 'Yoruba, Nigeria',
  ),
  Proverb(
    id: 'p21',
    text: 'Smooth seas never made a skilled mariner',
    meaning: 'Growth requires facing challenges, not avoiding them',
    region: 'England',
  ),
];
...
const List<Region> regions = [
  Region(
    id: 'oaxaca',
    name: 'Oaxaca, Mexico',
    description: 'Indigenous Zapotec and Mixtec traditions',
    storyCount: 12,
  ),
  Region(
    id: 'kerala',
    name: 'Kerala, India',
    description: 'Malabari oral histories and folk wisdom',
    storyCount: 8,
  ),
  Region(
    id: 'mali',
    name: 'Timbuktu, Mali',
    description: 'Songhay and Tuareg narratives',
    storyCount: 15,
  ),
  Region(
    id: 'iceland',
    name: 'Iceland',
    description: 'Norse-Icelandic mythology and contemporary folklore',
    storyCount: 6,
  ),
  Region(
    id: 'kyoto',
    name: 'Kyoto, Japan',
    description: 'Zen traditions and temple legends',
    storyCount: 11,
  ),
  Region(
    id: 'ghana',
    name: 'Akan regions, Ghana',
    description: 'Ashanti wisdom and Anansi tales',
    storyCount: 19,
  ),
  Region(
    id: 'vietnam',
    name: 'Mekong Delta, Vietnam',
    description: 'River folklore and agricultural proverbs',
    storyCount: 7,
  ),
  Region(
    id: 'ethiopia',
    name: 'Amhara, Ethiopia',
    description: 'Highland wisdom and ancient sayings',
    storyCount: 9,
  ),
];
